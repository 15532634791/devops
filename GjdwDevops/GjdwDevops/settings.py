"""
Django settings for GjdwDevops project.
...
SECRET_KEY = 'django-insecure-#png^ot8wif(zl71%-g+xcmk365y5)vgyyt6$91wfwq1jainn+'
...
INSTALLED_APPS = [
    ...
    'APPS.ProjectManage.AppInstance.apps.AppinstanceConfig',
    'APPS.ProjectManage.ArchitectureReview.apps.ArchitecturereviewConfig',
    'APPS.ProjectManage.ImageRepository.apps.ImagerepositoryConfig',
    'APPS.ProjectManage.NameSpace.apps.NamespaceConfig',
    'APPS.ProjectManage.DeploymentBuild.apps.DeploymentbuildConfig',
    'APPS.Login.apps.LoginConfig',
    'APPS.DBMonitor.RdsMonitor.apps.RdsmonitorConfig',
    'APPS.ConfigManage.AutoTools.apps.AutotoolsConfig',
...
WSGI_APPLICATION = 'GjdwDevops.wsgi.application'
...
#         'NAME': 'devops',
#         'USER': 'devops',
#         'PASSWORD': 'lrej%3927*RELP',
#         'HOST': 'devops-rm-i5xgp1h924z2g58d2.mysql.rds.1.ops.sgmc.sgcc.com.cn',
#         'PORT': '15406',
#
#     }
# }
